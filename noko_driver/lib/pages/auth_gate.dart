  ...
  Widget build(BuildContext context) {
    return StreamBuilder<User?>(
      ...
      builder: (context, snapshot) {
        ...
        if (user == null) {
          return const _DriverSignInPage();
        }
...
class _DriverSignInPage extends StatefulWidget {
  const _DriverSignInPage();

  @override
  State<_DriverSignInPage> createState() => _DriverSignInPageState();
}

class _DriverSignInPageState extends State<_DriverSignInPage> {
  ...
  Future<void> _signIn() async {
    ...
    if (email.isEmpty || password.isEmpty) {
      _showError('Enter your driver email and password.');
      return;
    }
